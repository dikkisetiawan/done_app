...
//main Color
Color kPrimaryColor = const Color(0xFF2697FF); //0xff56DCC5
Color kSecondaryColor = const Color(0xFF2A2D3E); //0xFF171A1F
...
//Gray Color Set
Color kBackgroundColor = const Color(0xFF212332); //0xFF000000
